...
[`r fontawesome::fa("github", a11y = "sem")` @yuchanmou](https://github.com/yuchanmou)<br>
...
```{r workflow, echo = FALSE, fig.cap = 'My R Markdown workflow', out.width = '80%', fig.align='center', cache=TRUE}
library(nomnoml)
nomnoml::nomnoml(
  "
  [<frame>Workflow|
...
- Two slides about using xaringan package  **(for presentation)**
...
- If you are interested in version control and open source
